...
let hasTechDeal;
if (cartB.includes("Laptop") || cartB.includes("Camera")) 
{
  hasTechDeal = "TRUE";
} 
else 
...
myBike = Object.create(vehicleBase);

myBike.kind = "bike";
myBike.wheels = 2;
myBike.powered = "EcoRide";
...
let o = displayName[0].toUpperCase();
let p = displayName.slice(1).toLowerCase();
displayName = o + p;
